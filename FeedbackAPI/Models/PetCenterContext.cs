...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1B1DD15115");
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F3BEE16EF13E");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__51BCD797C6C0E500");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2BE28C1DD2");
        ...
        {
            entity.HasKey(e => e.CategoryAttributeId).HasName("PK__Category__21D38D92D30BCC22");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.CategoryAttributes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CategoryA__Categ__6B24EA82");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B83CC1033B");

            entity.HasIndex(e => e.Email, "IX_Customers_Email");

            entity.HasIndex(e => e.PhoneNumber, "IX_Customers_PhoneNumber");

            entity.HasIndex(e => e.Email, "UQ__Customer__A9D105348D2123E2").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.CustomerId, e.VoucherId }).HasName("PK__Customer__A700832436F22AD6");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.CustomerVouchers)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CustomerV__Custo__7F2BE32F");

            entity.HasOne(d => d.Voucher).WithMany(p => p.CustomerVouchers)
                .HasForeignKey(d => d.VoucherId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CustomerV__Vouch__00200768");
        });

        modelBuilder.Entity<Image>(entity =>
        {
            entity.HasKey(e => e.ImageId).HasName("PK__Images__7516F4EC84D84B6A");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.Images)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Images__ProductI__66603565");
        });

        modelBuilder.Entity<ImportStock>(entity =>
        {
            entity.HasKey(e => e.ImportId).HasName("PK__ImportSt__8697678A03E34881");
            ...
            entity.HasOne(d => d.Staff).WithMany(p => p.ImportStocks)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ImportSto__Staff__05D8E0BE");

            entity.HasOne(d => d.Supplier).WithMany(p => p.ImportStocks)
                .HasForeignKey(d => d.SupplierId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ImportSto__Suppl__04E4BC85");
        });

        modelBuilder.Entity<ImportStockDetail>(entity =>
        {
            entity.HasKey(e => e.ImportStockDetailId).HasName("PK__ImportSt__CDCE9B693817EAA3");
            ...
            entity.HasOne(d => d.Import).WithMany(p => p.ImportStockDetails)
                ...
                .HasConstraintName("FK__ImportSto__Impor__09A971A2");

            entity.HasOne(d => d.Product).WithMany(p => p.ImportStockDetails)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__ImportSto__Produ__0A9D95DB");
        });

        modelBuilder.Entity<Order>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF65C8DF19");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Orders)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Orders__AddressI__114A936A");

            entity.HasOne(d => d.Customer).WithMany(p => p.Orders)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Orders__Customer__10566F31");

            entity.HasOne(d => d.Staff).WithMany(p => p.Orders)
                .HasForeignKey(d => d.StaffId)
                .HasConstraintName("FK__Orders__StaffID__123EB7A3");
        });

        modelBuilder.Entity<OrderDetail>(entity =>
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30CA9152606");

            entity.HasIndex(e => e.ProductId, "IX_OrderDetails_ProductID");

            entity.HasIndex(e => new { e.OrderId, e.ProductId }, "UQ__OrderDet__08D097C085BA0CEF").IsUnique();
            ...
            entity.HasOne(d => d.ImportStockDetail).WithMany(p => p.OrderDetails)
                ...
                .HasConstraintName("FK__OrderDeta__Impor__18EBB532");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED672FA918");
            ...
            entity.HasOne(d => d.Supplier).WithMany(p => p.Products)
                .HasForeignKey(d => d.SupplierId)
                .HasConstraintName("FK__Products__Suppli__619B8048");
        });

        modelBuilder.Entity<ProductAttribute>(entity =>
        {
            entity.HasKey(e => e.ProductAttributeId).HasName("PK__ProductA__00CE67273EF7E6E6");

            entity.HasIndex(e => new { e.ProductId, e.CategoryAttributeId }, "UQ__ProductA__8611FE35E33A149B").IsUnique();
            ...
            entity.HasOne(d => d.CategoryAttribute).WithMany(p => p.ProductAttributes)
                ...
                .HasConstraintName("FK__ProductAt__Categ__71D1E811");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductAttributes)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__ProductAt__Produ__70DDC3D8");
        });

        modelBuilder.Entity<ProductFeedback>(entity =>
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__ProductF__6A4BEDF6564C9E79");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductFe__Custo__208CD6FA");

            entity.HasOne(d => d.Order).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.OrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductFe__Order__22751F6C");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductFe__Produ__2180FB33");

            entity.HasOne(d => d.Staff).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.StaffId)
                .HasConstraintName("FK__ProductFe__Staff__236943A5");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AF74555BD");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staffs__96D4AAF7C0DECFEC");

            entity.HasIndex(e => e.Email, "UQ__Staffs__A9D10534CFDCA844").IsUnique();
            ...
            entity.HasMany(d => d.Roles).WithMany(p => p.Staff)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("StaffId", "RoleId").HasName("PK__StaffRol__2E7B0614A7672326");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE6669450C668F9");
        ...
        {
            entity.HasKey(e => e.VoucherId).HasName("PK__Vouchers__3AEE79C1411F60BB");

            entity.HasIndex(e => e.Code, "UQ__Vouchers__A25C5AA7A70AA79F").IsUnique();
