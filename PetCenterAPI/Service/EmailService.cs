...
<body style='font-family:Arial,sans-serif;background:#f5f5f5;'>
  <div style='max-width:600px;margin:0 auto;background:white;
    ...
    <h2 style='color:#2c3e50;border-bottom:3px solid #4285F4;padding-bottom:15px;'>
    ...
    <div style='background:#ecf0f1;padding:15px;
      ...
      <p><strong>Temporary Password:</strong>
        <span style='font-family:monospace;color:#e74c3c;font-size:16px;'>
          {tempPassword}
        </span>
      </p>
    </div>
    ...
    <p style='color:#7f8c8d;font-size:13px;margin-top:30px;'>
      © 2025 PetCenter. All rights reserved.
            ...
            {
                Console.WriteLine($"[EmailService] SendWelcomeEmail error: {ex.Message}");
                return false;
            }
        }
  ...
  <div style='max-width:600px;margin:0 auto;padding:40px 20px;'>
    <div style='background:white;border-radius:16px;overflow:hidden;
      ...
      <div style='padding:40px;'>
        ...
        <p style='color:#2ecc71;font-size:12px;word-break:break-all;
                  background:#f0fdf4;padding:10px 14px;border-radius:6px;margin:6px 0 0;'>
          {resetLink}
        </p>
      </div>
      <div style='background:#f8fafc;border-top:1px solid #e9ecef;
        ...
        <p style='color:#adb5bd;font-size:12px;margin:0;'>
          ...
          This is an automated message, please do not reply.
            ...
            {
                Console.WriteLine($"[EmailService] SendResetPasswordEmail error: {ex.Message}");
                return false;
            }
        }
    }
