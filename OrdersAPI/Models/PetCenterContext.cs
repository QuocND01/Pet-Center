...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1BB9248507");
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F3BEE1B9CF24");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Cart__51BCD797AF33E7F9");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Carts)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Cart__CustomerID__628FA481");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B2C06CCEB");
        ...
        {
            entity.HasKey(e => e.CategoryAttributeId).HasName("PK__Category__21D38D92DF7D2DF8");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.CategoryAttributes)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CategoryA__Categ__5812160E");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B838CDC528");

            entity.HasIndex(e => e.Email, "IX_Customers_Email");

            entity.HasIndex(e => e.PhoneNumber, "IX_Customers_PhoneNumber");

            entity.HasIndex(e => e.Email, "UQ__Customer__A9D10534AEF3108B").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.CustomerId, e.VoucherId }).HasName("PK__Customer__A70083249BD6196D");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__Images__7516F4EC3B136825");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.Images)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Images__ProductI__534D60F1");
        });

        modelBuilder.Entity<ImportStock>(entity =>
        {
            entity.HasKey(e => e.ImportId).HasName("PK__ImportSt__8697678A9511A397");
            ...
            entity.HasOne(d => d.Staff).WithMany(p => p.ImportStocks)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ImportSto__Staff__73BA3083");

            entity.HasOne(d => d.Supplier).WithMany(p => p.ImportStocks)
                .HasForeignKey(d => d.SupplierId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ImportSto__Suppl__72C60C4A");
        });

        modelBuilder.Entity<ImportStockDetail>(entity =>
        {
            entity.HasKey(e => e.ImportStockDetailId).HasName("PK__ImportSt__CDCE9B69D4D73174");
            ...
            entity.HasOne(d => d.Import).WithMany(p => p.ImportStockDetails)
                ...
                .HasConstraintName("FK__ImportSto__Impor__778AC167");

            entity.HasOne(d => d.Product).WithMany(p => p.ImportStockDetails)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__ImportSto__Produ__787EE5A0");
        });

        modelBuilder.Entity<Order>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAFEF4D06DC");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D30C796C452E");

            entity.HasIndex(e => e.ProductId, "IX_OrderDetails_ProductID");

            entity.HasIndex(e => new { e.OrderId, e.ProductId }, "UQ__OrderDet__08D097C0089DEFDE").IsUnique();
            ...
            entity.HasOne(d => d.ImportStockDetail).WithMany(p => p.OrderDetails)
                ...
                .HasConstraintName("FK__OrderDeta__Impor__06CD04F7");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED65E6F24C");
        ...
        {
            entity.HasKey(e => e.ProductAttributeId).HasName("PK__ProductA__00CE6727ECB6270E");

            entity.HasIndex(e => new { e.ProductId, e.CategoryAttributeId }, "UQ__ProductA__8611FE35E29BA63D").IsUnique();
            ...
            entity.HasOne(d => d.CategoryAttribute).WithMany(p => p.ProductAttributes)
                ...
                .HasConstraintName("FK__ProductAt__Categ__5EBF139D");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__ProductF__6A4BEDF650594052");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.CustomerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductFe__Custo__0E6E26BF");

            entity.HasOne(d => d.Order).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.OrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductFe__Order__10566F31");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__ProductFe__Produ__0F624AF8");

            entity.HasOne(d => d.Staff).WithMany(p => p.ProductFeedbacks)
                .HasForeignKey(d => d.StaffId)
                .HasConstraintName("FK__ProductFe__Staff__114A936A");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3A1A524D1B");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staffs__96D4AAF7314BD981");

            entity.HasIndex(e => e.Email, "UQ__Staffs__A9D10534F8094448").IsUnique();
            ...
            entity.HasMany(d => d.Roles).WithMany(p => p.Staff)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("StaffId", "RoleId").HasName("PK__StaffRol__2E7B061415064191");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE66694D7EE2E63");
        ...
        {
            entity.HasKey(e => e.VoucherId).HasName("PK__Vouchers__3AEE79C19B799F31");

            entity.HasIndex(e => e.Code, "UQ__Vouchers__A25C5AA79A61CE0E").IsUnique();
